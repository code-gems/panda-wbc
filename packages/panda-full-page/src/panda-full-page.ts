...
// types
import { PandaFullPageContent } from "./panda-full-page-content";

// styles
import { styles } from "./styles/styles";

// components
import "./panda-full-page-content";

// utils
import { LitElement, html, TemplateResult } from "lit";
import { customElement, property, query, queryAssignedElements } from "lit/decorators.js";

@customElement("panda-full-page")
export class PandaFullPage extends LitElement {
	// css styles
	static get styles() {
		return styles;
	}
