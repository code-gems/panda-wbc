...
export const styles = css`
	...
	.password-field.mandatory:hover {
	...
	:host([theme="valid"]) .password-field:not(.disabled) {
	...
	:host([theme="mandatory"]) .password-field:not(.disabled) {
		border: 1px solid var(--panda-form-validation-mandatory, hsl(29deg 100% 59%));
		box-shadow: 0px 0px 0px 2px var(--panda-form-validation-mandatory, hsl(29deg 100% 59%));
	}

	:host([theme="invalid"]) .password-field:not(.disabled) {
	...
	:host([theme="primary"]) .password-field:not(.disabled) {
		border: 1px solid var(--panda-primary-color, hsl(209deg 78% 46%));
		box-shadow: 0px 0px 0px 2px var(--panda-primary-color, hsl(209deg 78% 46%));
	}
	...
	:host([disabled]) .password-field .input {
		color: var(--panda-input-text-color-disabled, hsl(0deg 0% 68%));
	}

	/* FOCUSED STATE */
	:host([focused]) .password-field {
