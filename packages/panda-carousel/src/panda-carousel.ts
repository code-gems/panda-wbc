...
// types
import { PandaCarouselSlide } from "./panda-carousel-slide";

// styles
import { styles } from "./styles/styles";

// components
import "./panda-carousel-slide";

// utils
import { LitElement, html, TemplateResult } from "lit";
import { customElement, property, query, queryAssignedElements } from "lit/decorators.js";

@customElement("panda-carousel")
export class PandaCarousel extends LitElement {
	// css styles
	static get styles() {
		return styles;
	}
