export const pandaThemeLight = /*css*/ `
	:root {
		...
		--panda-highlight-text-color: hsl(210deg 5% 25%);
		...
		--panda-border-color-focused: hsl(207deg 1% 80%);
		--panda-border-color-working: hsl(207deg 1% 85%);
		...
		--panda-button-border-color: transparent;
		--panda-button-border-color-hover: transparent;
		--panda-button-border-gradient: linear-gradient(
			to bottom, 
			hsl(207deg 1% 85%), 
			hsl(207deg 1% 75%)
		);
