...
export const styles = css`
	...
	.callout {
		...
		border: 1px solid var(--panda-background-color-500, hsl(0deg 0% 92%));
	...
	:host([theme~="primary"]) {
		...
		--panda-spinner-color: var(--panda-primary-color, hsl(209deg 78% 46%));
	}

	/* SECONDARY */
	:host([theme~="secondary"]) {
		--panda-icon-color: var(--panda-secondary-color, hsl(164deg 67% 45%));
		--panda-spinner-color: var(--panda-secondary-color, hsl(164deg 67% 45%));
	}

	/* TERTIARY */
	:host([theme~="tertiary"]) {
		--panda-icon-color: var(--panda-tertiary-color, hsl(164deg 67% 45%));
		--panda-spinner-color: var(--panda-tertiary-color, hsl(164deg 67% 45%));
	}
