export const themeLight = /*css*/ `
	:root {
		...
		/* BACKGROUND COLOR */
		--panda-background-color: hsl(345deg 86% 46%);

		--panda-background-color-50: hsl(345deg 86% 64%);
		--panda-background-color-100: hsl(345deg 86% 54%);
		--panda-background-color-300: hsl(345deg 86% 50%);
		--panda-background-color-500: hsl(345deg 86% 46%);
		--panda-background-color-700: hsl(345deg 86% 42%);
		--panda-background-color-900: hsl(345deg 86% 38%);

		--panda-background-color-0opc: hsl(345deg 86% 46% / 0%);
		--panda-background-color-10opc: hsl(345deg 86% 46% / 10%);
		--panda-background-color-20opc: hsl(345deg 86% 46% / 20%);
		--panda-background-color-30opc: hsl(345deg 86% 46% / 30%);
		--panda-background-color-40opc: hsl(345deg 86% 46% / 40%);
		--panda-background-color-50opc: hsl(345deg 86% 46% / 50%);
		--panda-background-color-60opc: hsl(345deg 86% 46% / 60%);
		--panda-background-color-70opc: hsl(345deg 86% 46% / 70%);
		--panda-background-color-80opc: hsl(345deg 86% 46% / 80%);
		--panda-background-color-90opc: hsl(345deg 86% 46% / 90%);
		...
		--panda-text-color: hsl(340deg 42% 12%);
		--panda-text-color-hover: hsl(340deg 42% 17%);
		--panda-text-color-disabled: hsl(340deg 42% 22%);
		--panda-text-shadow: none;
		--panda-text-line-height: 1.6em;

		--panda-header-text-color: hsl(0deg 0% 100%);
		--panda-header-text-color-hover: hsl(0deg 0% 100%);
		--panda-header-text-color-disabled: hsl(0deg 0% 100%);
