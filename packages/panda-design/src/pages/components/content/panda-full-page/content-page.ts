...
// components
import "@panda-wbc/panda-full-page";
...
@customElement("panda-full-page-content-page")
@page(pageConfig)
		...
		<div class="content-section" data-content-section-name="${ContentSectionName.OVERVIEW}">
			...
			<div class="sample-cont">
				<div class="sample">
					...
					>
						<panda-full-page-content class="page-1">
							PAGE 1
						</panda-full-page-content>
						<panda-full-page-content class="page-2">
							PAGE 2
						</panda-full-page-content>
						<panda-full-page-content class="page-3">
							PAGE 3
						</panda-full-page-content>
					</panda-full-page>
