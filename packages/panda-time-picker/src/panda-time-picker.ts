...
export class PandaTimePicker extends HTMLElement {
	...
	constructor() {
		...
		this.shadowRoot!.innerHTML = /*html*/`
			<div class="time-picker" part="time-picker">
				...
				<div class="picker-button" part="picker-button" tabindex="0">
					<div class="picker-icon" part="picker-icon">
	...
	private _setFocus(index: number): void {
		...
		console.log(`%c ⚡ [PANDA TIME PICKER] (_setFocus)`, "font-size: 24px; color: crimson; background: black;", inputEl, index);
		if (inputEl) {
			inputEl.focus();
		}
	}
