...
@customElement("panda-details-dialog-overlay")
export class PandaDetailsDialogOverlay extends LitElement {
	//css styles
	static get styles() {
...
declare global {
	interface HTMLElementTagNameMap {
		"panda-details-dialog-overlay": PandaDetailsDialogOverlay;
	}
}
