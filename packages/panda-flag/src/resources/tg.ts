...
export const flagTg = (square: boolean): string => {
	return square
		? /*svg*/`
			...
			<polygon fill="#F0F0F0" points="76.999,22.445 88.663,58.346 126.42,58.346 95.875,80.543 107.539,116.445 76.999,94.258 
		...
		: /*svg*/`
			...
			<polygon fill="#F0F0F0" points="57.75,16.833 66.498,43.76 94.815,43.76 71.906,60.407 80.654,87.334 57.75,70.693 34.845,87.334 
