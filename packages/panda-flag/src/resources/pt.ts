	...
	return !square
		? /*svg*/`
			...
			<style>
				...
				<path class="cls-7" d="M115.28,89.28h-.52v.37h-.37v-.38h-.53v.38h-.38v-.38h-.52v.87a.22.22,0,0,0,.23.22H115a.25.25,0,0,0,.24-.23v-.85Z"/>
				<path class="cls-7" d="M110.73,89.28h-.52v.37h-.37v-.38h-.53v.38h-.38v-.38h-.52v.87a.22.22,0,0,0,.23.22h1.85a.24.24,0,0,0,.24-.23v-.85Z"/>
				<path d="M112,90a.19.19,0,1,0-.37,0v.66H112v-.66"/>
		...
		: /*svg*/`
			...
			>
				...
				<path class="g" d="M60.11,90.82h.72v.52h.52v-.53h.74v.53h.53v-.53h.73V92a.31.31,0,0,1-.32.31H63.61a.33.33,0,0,1-.34-.32V90.82Z"/>
				...
				<path class="g" d="M87.52,90.82h.72v.52h.52v-.53h.74v.53h.53v-.53h.73V92a.31.31,0,0,1-.33.31H87.86a.33.33,0,0,1-.34-.32V90.82Z"/>
				...
				<path class="h" d="M119.41,151.9l-.51-.51-.37.37-.37-.37.38-.38-.52-.52-.38.38-.37-.37.38-.38-.52-.52-.85.85a.31.31,0,0,0,0,.45l1.83,1.84a.33.33,0,0,0,.46,0l.84-.84Z"/>
