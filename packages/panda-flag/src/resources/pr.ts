...
export const flagPr = (square: boolean): string => {
	return square
		? /*svg*/`
			...
			<path fill="#FFFFFF" d="M29.998,159.5L51,144.8l21.002,14.7l-7.875-24.154l20.996-15.221H58.875L51,96.5l-7.875,23.625H16.877
		...
		: /*svg*/`
			...
			<path fill="#FFFFFF" d="M25.33,127L46,112.532L66.67,127l-7.75-23.775L79.58,88.25H53.75L46,65l-7.75,23.25H12.42l20.66,14.974
				L25.33,127z"/>
		`;
}