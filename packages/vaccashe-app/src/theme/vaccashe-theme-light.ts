export const vaccasheThemeLight = /*css*/ `
	:root {
		/* LIGHT THEME */
		/* ========================================================================================================= */
		/* BASE COLORS ============================================================================================= */
		...
		/* BACKGROUND COLOR */
		--panda-background-color: hsl(40deg 69% 97%);

		--panda-background-color-50: hsl(40deg 69% 100%);
		--panda-background-color-100: hsl(40deg 69% 100%);
		--panda-background-color-300: hsl(40deg 69% 99%);
		--panda-background-color-500: hsl(40deg 69% 97%);
		--panda-background-color-700: hsl(35deg 55% 94%);
		--panda-background-color-900: hsl(35deg 53% 91%);

		--panda-background-color-0opc: hsl(40deg 69% 97% / 0%);
		--panda-background-color-10opc: hsl(40deg 69% 97% / 10%);
		--panda-background-color-20opc: hsl(40deg 69% 97% / 20%);
		--panda-background-color-30opc: hsl(40deg 69% 97% / 30%);
		--panda-background-color-40opc: hsl(40deg 69% 97% / 40%);
		--panda-background-color-50opc: hsl(40deg 69% 97% / 50%);
		--panda-background-color-60opc: hsl(40deg 69% 97% / 60%);
		--panda-background-color-70opc: hsl(40deg 69% 97% / 70%);
		--panda-background-color-80opc: hsl(40deg 69% 97% / 80%);
		--panda-background-color-90opc: hsl(40deg 69% 97% / 90%);
		...
		--panda-text-color: hsl(26deg 23% 7%);
		...
		--panda-header-font-size-m: 54px;
		--panda-header-font-size-l: 72px;
		--panda-header-font-size-xl: 112px;
		...
		--panda-component-size-s: 36px;
		--panda-component-size-m: 48px;
		--panda-component-size-l: 60px;
		--panda-component-size-xl: 72px;
		
		--panda-border-color: hsl(34deg 16% 84%);
		--panda-border-color-hover: hsl(34deg 16% 80%);
		--panda-border-color-disabled: hsl(34deg 16% 87%);
		...
		/* LABEL */
		--panda-label-color: hsl(26deg 9% 33%);
		...
		/* BORDER RADIUS */
		--panda-input-border-radius-size-s: 18px;
		--panda-input-border-radius-size-m: 24px;
		--panda-input-border-radius-size-l: 30px;
		--panda-input-border-radius-size-xl: 36px;
		/* ICON STYLES */
		...
		--panda-icon-color: hsl(26deg 23% 7%);
		--panda-icon-color-disabled: hsl(26deg 23% 17%);
